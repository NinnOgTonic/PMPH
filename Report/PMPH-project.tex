...
\newcommand{\thepaperauthor}{Morten Espensen \& Niklas Høj \& Mathias Svensson}
...
We have included 6 versions of our code in the attached zip archive:
...
\item The directory \texttt{2\_OpenMP} contains our OpenMP code, which
  parallelises the outer loop in \texttt{run\_OrigCPU}.
\item The directory \texttt{3\_NaiveCuda} contains our initial CUDA
  ...
  simply taken the loops that were naïvely parallelisable and
...
\item The directory \texttt{6\_CudaFinal} is our final version. It is for
  ...
  almost every memory access has been made coalesced.
\end{itemize}
...
\begin{itemize}
  \item The loop in \texttt{value} has dependencies on previous
...
Every other loop is completely parallelisable.

\chapter{Transformations}
\input{transform_1_2.tex}
\input{transform_1_3.tex}
\input{transform_3_4.tex}
\input{transform_4_5.tex}
\input{transform_5_6.tex}
